...
import MyBreadcrumb from '../detail/MyBreadcrumb';
  ...
  return (
    <div style={{ marginTop: '20px', boxSizing: 'border-box' }}>
      ...
      <div style={{ display: 'flex', minHeight: '100vh', padding: '20px', boxSizing: 'border-box' }}>
        <div style={{ width: '18%', padding: '50px 20px', marginRight: '5px', position: 'fixed', top: '218px', left: '90px', backgroundColor: 'white' }}>
          <Collapse
            bordered={false}
